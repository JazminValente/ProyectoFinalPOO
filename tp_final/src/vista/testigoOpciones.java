...
public class testigoOpciones extends JPanel {
	...
	public testigoOpciones() {
		...
		JButton bAgregarModificarT = new JButton("AGREGAR");
		bAgregarModificarT.setFont(new Font("Tahoma", Font.BOLD, 11));
		bAgregarModificarT.addActionListener(new ActionListener() {
		...
		bAgregarModificarT.setBounds(165, 169, 264, 40);
		add(bAgregarModificarT);
		...
		bConsultarEliminarT.setBounds(165, 220, 264, 40);
		...
		bAtras.setBounds(165, 271, 264, 40);
		add(bAtras);
