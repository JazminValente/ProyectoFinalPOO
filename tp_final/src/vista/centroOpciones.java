...
public class centroOpciones extends JPanel {
	...
	public centroOpciones() {
		...
		JButton agregarModificarCentro = new JButton("AGREGAR");
		agregarModificarCentro.addActionListener(new ActionListener() {
		...
		agregarModificarCentro.setFont(new Font("Sitka Heading", Font.BOLD, 14));
		agregarModificarCentro.setBounds(185, 128, 211, 23);
		add(agregarModificarCentro);
		...
		botonConsultarC.setBounds(185, 183, 211, 23);
		add(botonConsultarC);
		...
		bAtras.setBounds(185, 242, 211, 23);
		add(bAtras);
