...
public class noIdentificadoModificarCentros extends JPanel {
	...
	public noIdentificadoModificarCentros(NoIdentificados noIdent) {
		...
		centrosEnLosQueYaEstuvo = noIdent.getCentrosEnLosQueEstuvo();
		...
		btnVincularCentro.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				boolean seVincula = noIdentificadoDao.agregarCentroAlNoIdentificado(noIdent, centroAVincular);
		...
		btnDesvincularCentro.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				boolean seDesvincula = noIdentificadoDao.desvincularCentroDelNoIdentificado(noIdent, centroADesvincular);
	...
	private void datosCentrosDisponibles() {
        ...
        if (centrosEnLosQueYaEstuvo.size() == 0) {
            ...
            for (CCDTyE c : centroDisponibles) {
                for (CCDTyE centro : noIdentificado.getCentrosEnLosQueEstuvo()) {
